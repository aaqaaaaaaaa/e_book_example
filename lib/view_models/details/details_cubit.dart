...
import 'package:e_book_example/components/download_alert.dart';
import 'package:e_book_example/database/download_helper.dart';
import 'package:e_book_example/database/favorite_helper.dart';
  ...
  getFeed(String url) async {
    ...
    try {
      ...
      emit(DetailsLoadedState(
          ...
          related: related,
          loading: false,
          downloaded: downloaded));  // setLoading(false);
    } catch (e) {
      throw (e);
    }
  }
